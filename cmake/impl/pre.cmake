...
foreach(LANG IN ITEMS C CXX)
    if(DEFINED CMAKE_${LANG}_COMPILER_LAUNCHER AND NOT CMAKE_${LANG}_COMPILER_LAUNCHER STREQUAL "")
        set(_NBL_COMPILER_LAUNCHER "${CMAKE_${LANG}_COMPILER_LAUNCHER}")
        list(GET _NBL_COMPILER_LAUNCHER 0 _NBL_COMPILER_LAUNCHER_HEAD)
        if(NOT _NBL_COMPILER_LAUNCHER_HEAD STREQUAL "${SHELL_LOCATION}")
            list(PREPEND _NBL_COMPILER_LAUNCHER "${SHELL_LOCATION}")
            set(CMAKE_${LANG}_COMPILER_LAUNCHER "${_NBL_COMPILER_LAUNCHER}" CACHE STRING "" FORCE)
        endif()
    endif()
endforeach()

unset(_NBL_COMPILER_LAUNCHER)
unset(_NBL_COMPILER_LAUNCHER_HEAD)
